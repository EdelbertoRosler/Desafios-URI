...
public class Uniformes {
            ...
            Arrays.sort(tshirts, new Comparator<Tshirt>() {
                ...
                public int compare(Tshirt t1, Tshirt t2) {
                    ...
                    if (diff != 0) {
                        ...
                        if (s1.equals("P") && s2.equals("M")
                                || s1.equals("P") && s2.equals("G")
                                || s1.equals("M") && s2.equals("G")) {
                            return -1;
                        }
                        return 1;
                    }
    ...
    private static String read() throws IOException { return in.readLine(); }
